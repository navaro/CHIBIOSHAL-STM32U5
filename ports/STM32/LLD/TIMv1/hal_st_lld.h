...
#define STM32_ST_USE_LPTIM2					TRUE

#if defined(STM32_TIM2_SUPPRESS_ISR)
#define STM32_SYSTICK_SUPPRESS_ISR
#endif
#define ST_LLD_NUM_ALARMS                   1 // STM32_TIM2_CHANNELS
...
#if !OSAL_LPST_MODE && (OSAL_ST_MODE == OSAL_ST_MODE_FREERUNNING) || defined(__DOXYGEN__)
