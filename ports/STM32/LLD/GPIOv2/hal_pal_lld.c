 ...
 * @notapi
 */
void _pal_lld_maskpadevent(ioportid_t port,
                             iopadid_t pad) {

  uint32_t padmask ;
  //uint32_t cridx, croff, crmask, portidx;
 ...
 * @notapi
 */
void _pal_lld_unmaskpadevent(ioportid_t port,
                             iopadid_t pad) {
 ...
 * @notapi
 */
void _pal_lld_swevent(ioportid_t port,
                             iopadid_t pad) {
