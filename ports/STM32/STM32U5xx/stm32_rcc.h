 ...
 * @api
 */
#define rccEnableAPB4(mask, lp, srlp) {                                           \
  RCC->APB4ENR |= (mask);                                                   \
  if (lp)                        {											\
    RCC->APB4LPENR |= (mask);                                               \
    }																		\
 ...
 * @api
 */
#define rccDisableAHB4SRDAMR(mask) {                                              \
  RCC->AHB4ENR &= ~(mask);                                                  \
  RCC->SRDAMR &= ~(mask);                                                \
  (void)RCC->AHB4LPENR;                                                     \
  (void)RCC->SRDAMR;                                                     \
 ...
 * @api
 */
#define rccEnableAHB4SRDAMR(mask, lp) {                                           \
  RCC->AHB4ENR |= (mask);                                                   \
  if (lp)                                                                   \
    RCC->SRDAMR |= (mask);                                               \
  else                                                                      \
 ...
 * @api
 */
#define rccEnableDMA1(lp) rccEnableAHB1(RCC_AHB1ENR_GPDMA1EN, lp)
 ...
 * @api
 */
#define rccDisableDMA1() rccDisableAHB1(RCC_AHB1ENR_GPDMA1EN)
 ...
 * @api
 */
#define rccEnableSRAM1(lp) rccEnableAHB2(RCC_AHB2ENR_AHBSRAM1EN_Msk, lp)
 ...
 * @api
 */
#define rccEnableSRAM3(lp) rccEnableAHB4SRDAMR(RCC_AHB4ENR_SRDSRAMEN, lp)
 ...
 * @api
 */
#define rccDisableSRAM3() rccDisableAHB4SRDAMR(RCC_AHB4ENR_SRDSRAMEN)
/** @} */
 ...
 * @api
 */
#define rccEnableI2C1(lp) rccEnableAPB1L(RCC_APB1ENR1_I2C1EN, lp)
 ...
 * @api
 */
#define rccDisableI2C1() rccDisableAPB1L(RCC_APB1ENR1_I2C1EN)
 ...
 * @api
 */
#define rccResetI2C1() rccResetAPB1L(RCC_APB1RSTR1_I2C1RST)
 ...
 * @api
 */
#define rccEnableI2C2(lp) rccEnableAPB1L(RCC_APB1ENR1_I2C2EN, lp)
 ...
 * @api
 */
#define rccDisableI2C2() rccDisableAPB1L(RCC_APB1ENR1_I2C2EN)
 ...
 * @api
 */
#define rccResetI2C2() rccResetAPB1L(RCC_APB1RSTR1_I2C2RST)
 ...
 * @api
 */
#define rccEnableI2C4(lp) rccEnableAPB4(RCC_APB4ENR_I2C4EN, lp, false)
...
#define rccEnableUSB_OTG(lp) rccEnableAHB2(RCC_AHB2ENR1_OTGEN, lp)
...
#define rccDisableUSB_OTG() rccDisableAHB2(RCC_AHB2ENR1_OTGEN)
...
#define rccResetUSB_OTG() rccResetAHB1(RCC_AHB2RSTR1_OTGRST)
 ...
 * @api
 */
#define rccEnableRNG(lp) rccEnableAHB2(RCC_AHB2ENR1_RNGEN, lp)
 ...
 * @api
 */
#define rccDisableRNG() rccDisableAHB2(RCC_AHB2ENR1_RNGEN )
 ...
 * @api
 */
#define rccEnableSPI2(lp) rccEnableAPB1L(RCC_APB1ENR1_SPI2EN, lp)
 ...
 * @api
 */
#define rccDisableSPI2() rccDisableAPB1L(RCC_APB1ENR1_SPI2EN)
 ...
 * @api
 */
#define rccEnableSPI6(lp) rccEnableAPB4(RCC_APB4ENR_SPI6EN, lp, false)
 ...
 * @api
 */
#define rccEnableLPTIM1(lp) rccEnableAPB1L(RCC_APB1LENR_LPTIM1EN, lp)
 ...
 * @api
 */
#define rccDisableLPTIM1() rccDisableAPB1L(RCC_APB1LENR_LPTIM1EN)
 ...
 * @api
 */
#define rccResetLPTIM1() rccResetAPB1L(RCC_APB1LRSTR_LPTIM1RST)

/**
 * @name    LPTIM2 peripherals specific RCC operations
 * @{
 */
/**
 * @brief   Enables the LPTIM1 peripheral clock.
 ...
 * @api
 */
#define rccEnableLPTIM2(lp) rccEnableAPB4(RCC_APB4ENR_LPTIM2EN, lp, lp)
 ...
 * @api
 */
#define rccDisableLPTIM2() rccDisableAPB4(RCC_APB4ENR_LPTIM2EN)
 ...
 * @api
 */
#define rccResetLPTIM2() rccResetAPB4L(RCC_APB4RSTR_LPTIM3RST)
 ...
 * @api
 */
#define rccEnableTIM3(lp) rccEnableAPB1L(RCC_APB1ENR1_TIM3EN, lp)
 ...
 * @api
 */
#define rccDisableTIM3() rccDisableAPB1L(RCC_APB1ENR1_TIM3EN)
 ...
 * @api
 */
#define rccResetTIM3() rccResetAPB1L(RCC_APB1RSTR1_TIM3RST)
 ...
 * @api
 */
#define rccEnableTIM4(lp) rccEnableAPB1L(RCC_APB1ENR1_TIM4EN, lp)
 ...
 * @api
 */
#define rccDisableTIM4() rccDisableAPB1L(RCC_APB1ENR1_TIM4EN)
 ...
 * @api
 */
#define rccResetTIM4() rccResetAPB1L(RCC_APB1ENR1_TIM4EN)
 ...
 * @api
 */
#define rccEnableUSART2(lp) rccEnableAPB1L(RCC_APB1ENR1_USART2EN, lp)
 ...
 * @api
 */
#define rccDisableUSART2() rccDisableAPB1L(RCC_APB1ENR1_USART2EN)
 ...
 * @api
 */
#define rccEnableUSART3(lp) rccEnableAPB1L(RCC_APB1ENR1_USART3EN, lp)
 ...
 * @api
 */
#define rccDisableUSART3() rccDisableAPB1L(RCC_APB1ENR1_USART3EN)
 ...
 * @api
 */
#define rccEnableUART4(lp) rccEnableAPB1L(RCC_APB1ENR1_UART4EN, lp)
 ...
 * @api
 */
#define rccDisableUART4() rccDisableAPB1L(RCC_APB1RSTR1_UART4RST)
 ...
 * @api
 */
#define rccEnableUART5(lp) rccEnableAPB1L(RCC_APB1ENR1_UART5EN, lp)
 ...
 * @api
 */
#define rccDisableUART5() rccDisableAPB1L(RCC_APB1ENR1_UART5EN)
...
#define RCC_CD_CLOCK_REQ()		rcc_cd_clock_req()
#define RCC_CD_CLOCK_REL()		rcc_cd_clock_rel()

#define RCC_SYSTEM_SPEED_4				0
#define RCC_SYSTEM_SPEED_8				1
#define RCC_SYSTEM_SPEED_16				2
#define RCC_SYSTEM_SPEED_32				3
#define RCC_SYSTEM_SPEED_64				4
#define RCC_SYSTEM_SPEED_160			5
#define RCC_SYSTEM_SPEED_200			6
...
extern unsigned int rcc_sys_ck(void) ;
extern unsigned int rcc_sys_ck_cpu(void) ;
extern unsigned int rcc_sys_ck_bus(void) ;

extern bool rcc_cd_clock_req(void) ;
extern void rcc_sys_speed (uint32_t speed) ;
